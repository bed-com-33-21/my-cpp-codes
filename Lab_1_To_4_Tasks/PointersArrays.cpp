...
int main(){
  ...
  *pPointer = 10; //assign a value to the first element
  ...
  pPointer++;
  *pPointer = 20; //ssign a value to the second element
...
/*assign the address of the fourth element to the pointer using pointer arithmetric*/
...
/*assign a value to the fifth element using indirection and pointer arithmetric*/
*(pPointer + 4) = 50;
